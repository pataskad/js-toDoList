...
function showHighPriorityTasks() {
        ...
        let highPriorityItems = _.filter(myToDoItems, ['priority', 3])
...
function showMediumPriorityTasks() {
    ...
    // filtered original array via lodash
    let mediumPriorityItems = _.filter(myToDoItems, ['priority', 2])
...
function showLowPriorityTasks() {
    ...
    let lowPriorityItems = _.filter(myToDoItems, ['priority', 1])
